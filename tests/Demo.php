...
use UMSdk\Android\AndroidCustomizedcast;
use UMSdk\Android\AndroidFilecast;
use UMSdk\Android\AndroidGroupcast;
use UMSdk\Android\AndroidUnicast;
use UMSdk\Ios\IOSBroadcast;
use UMSdk\Ios\IOSCustomizedcast;
use UMSdk\Ios\IOSFilecast;
use UMSdk\Ios\IOSGroupcast;
...
class Demo
{
    ...
    function sendIOSUnicast($deviceToken)
    {
        try {

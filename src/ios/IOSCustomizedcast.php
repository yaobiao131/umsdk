...
class IOSCustomizedcast extends IOSNotification
{
    ...
    {
        parent::isComplete();
        if (!array_key_exists("alias", $this->data) && !array_key_exists("file_id", $this->data)) throw new Exception("You need to set alias or upload file for customizedcast!");
    }
    ...
    function getFileId()
    {
        if (array_key_exists("file_id", $this->data)) return $this->data["file_id"];
        return NULL;
    }
}